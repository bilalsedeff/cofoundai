"""
CoFound.ai "prototype" İş Akışı Görselleştirme

Bu script, CoFound.ai 'prototype' iş akışını görselleştirir.
"""
...
def main():
    """Ana işlev - prototype iş akışı şemasını oluşturur."""
    print("CoFound.ai 'prototype' İş Akışı Görselleştirme")
    print("============================================\n")
    ...
    try:
        ...
        # prototype iş akışını bul
        workflow_data = None
        for wf in workflow_config.get("main", {}).get("workflows", []):
            if wf.get("id") == "prototype":
                workflow_data = wf
                break
        
        if not workflow_data:
            print("Hata: 'prototype' iş akışı bulunamadı!")
            return
        ...
        print("'prototype' iş akışını görselleştirebilirsiniz.")
