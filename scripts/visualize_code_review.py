"""
CoFound.ai "code_review" İş Akışı Görselleştirme

Bu script, CoFound.ai 'code_review' iş akışını görselleştirir.
"""
...
def main():
    """Ana işlev - code_review iş akışı şemasını oluşturur."""
    print("CoFound.ai 'code_review' İş Akışı Görselleştirme")
    print("=============================================\n")
    ...
    try:
        ...
        # code_review iş akışını bul
        workflow_data = None
        for wf in workflow_config.get("main", {}).get("workflows", []):
            if wf.get("id") == "code_review":
                workflow_data = wf
                break
        
        if not workflow_data:
            print("Hata: 'code_review' iş akışı bulunamadı!")
            return
        ...
        print("'code_review' iş akışını görselleştirebilirsiniz.")
