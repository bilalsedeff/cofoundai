    ...
    async def test_agent_creation(self):
        ...
        try:
            agent_config = {
                ...
                "system_prompt":
                "You are a test agent. Respond helpfully and concisely.",
...
Respond in JSON format with: {
  ...
  "brief": "Project brief description"
                ...
                "system_prompt":
                """You are a blueprint generator. Create detailed project blueprints including:
...
Format your response as a structured blueprint document.""",
            ...
            # Create orchestrator
            orchestrator = AgenticGraph(project_id="test_dream", agents=agents)
            ...
            if isinstance(result, dict) and "messages" in result:
                ...
                if messages:
                    ...
                    logger.info(
                        f"Final response: {last_message.content[:200]}...")
    ...
    async def test_api_simulation(self):
        ...
        try:
            ...
            dream_request = {
                "vision_text":
                "Create a todo list app with AI-powered task prioritization",
...
"""
            ...
            logger.info(
                f"Estimated cost: ${result['cost_estimate']['cost_usd']:.4f}")
